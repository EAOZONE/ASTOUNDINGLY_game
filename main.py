...
pygame.init()
pygame.display.set_caption("ASTOUNDINGLY")
...
def start(font, font_instructions):
    ...
    name_surface = font.render("Welcome to ASTOUNDINGLY!", True, WHITE)
    ...
    SCREEN.blit(name_surface, (40, BASE_OFFSET_Y - 70))
    SCREEN.blit(start_surface, (40, BASE_OFFSET_Y))
    SCREEN.blit(instruction_surface, (40, BASE_OFFSET_Y + 70))
    pressed = True
...
def instruction(font):
    ...
    instructions_9_surface = font.render("it is right.", True, WHITE)
    ...
    instructions_14_surface = font.render("Press '1' anytime to come back", True, WHITE)
    instructions_15_surface = font.render("Press 'Q' to go back", True, WHITE)
    variables = [instructions_1_surface, instructions_2_surface, instructions_3_surface, instructions_4_surface,
                 ...
                 instructions_13_surface, instructions_14_surface, instructions_15_surface]
    for i in range(len(variables)):
        SCREEN.blit(variables[i], (40, BASE_OFFSET_Y - 90 + 45*(i-1)))
    pressed = True
    pygame.display.update()
    while pressed:
        for event in pygame.event.get():
...
def draw_title(font):
    ...
    title_surface = font.render("ASTOUNDINGLY", True, WHITE)
